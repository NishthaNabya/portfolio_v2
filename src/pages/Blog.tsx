...
const Leadership: React.FC = () => {
  return (
    <section className="pt-8 sm:pt-12 md:pt-16 pb-8 px-0 sm:px-4">
      ...
      >
        <h1 className="text-3xl sm:text-4xl font-bold text-gray-900 mb-4 sm:mb-6">Leadership</h1>
        <div className="w-24 h-1 bg-accent mx-auto mb-6 sm:mb-8" />
        <div className="max-w-4xl mx-auto px-4">
          <blockquote className="text-lg sm:text-xl md:text-2xl font-medium text-gray-800 leading-relaxed mb-4 sm:mb-6">
          ...
          <div className="text-sm sm:text-base text-gray-600">— My Leadership Philosophy</div>
        </div>
      </motion.div>
      ...
      <div className="mb-12 sm:mb-16 md:mb-20">
        <motion.h2 
          ...
          viewport={{ once: true, amount: 0.2 }}
          transition={{ duration: 0.5 }}
          className="text-xl sm:text-2xl font-bold text-gray-900 mb-8 sm:mb-10 md:mb-12 text-center"
        >
          Leadership Journey
        </motion.h2>
            ...
            {leadershipRoles.map((role, index) => (
              ...
              >
                ...
                <div className="w-full md:w-5/12 md:pr-8">
                  <div className="bg-white rounded-xl p-4 sm:p-6 md:p-8 shadow-lg border border-gray-100 hover:shadow-xl transition-shadow duration-300">
                    <div className="flex items-center gap-3 sm:gap-4 mb-4 sm:mb-6">
                      <div 
                        className="w-12 h-12 sm:w-14 sm:h-14 md:w-16 md:h-16 rounded-full flex items-center justify-center text-white text-xl sm:text-2xl shadow-lg flex-shrink-0"
                      ...
                      <div className="min-w-0 flex-1">
                        ...
                        <div className="text-sm sm:text-base text-accent font-semibold">{role.organization}</div>
                      </div>
                    </div>
                    
                    <p className="text-sm sm:text-base text-gray-700 leading-relaxed mb-4 sm:mb-6">{role.description}</p>
                    
                    {/* Impact Grid */}
                    <div className="grid grid-cols-3 gap-2 sm:gap-3">
                      {role.impact.map((metric, metricIndex) => (
                        <div key={metricIndex} className="text-center p-2 sm:p-3 bg-gray-50 rounded-lg">
                          <div className="text-base sm:text-lg font-bold text-accent">{metric}</div>
                ...
                {/* Date Badge */}
                <div className="w-full md:w-5/12 md:pl-8 mt-4 md:mt-0 flex md:justify-start">
                  <div className="bg-accent/10 rounded-full px-3 sm:px-4 py-2">
                    <div className="text-xs sm:text-sm font-semibold text-accent">{role.period}</div>
      ...
      >
        <h2 className="text-xl sm:text-2xl font-bold text-gray-900 mb-8 sm:mb-10 md:mb-12 text-center">Leadership Principles</h2>
        <div className="grid sm:grid-cols-2 md:grid-cols-3 gap-6 sm:gap-8">
          <div className="text-center">
            ...
            <h3 className="text-base sm:text-lg font-bold text-gray-900 mb-3 sm:mb-4">Vision-Driven</h3>
          ...
          <div className="text-center">
            ...
            <h3 className="text-base sm:text-lg font-bold text-gray-900 mb-3 sm:mb-4">People-First</h3>
            <p className="text-sm sm:text-base text-gray-600 leading-relaxed">
          ...
          <div className="text-center sm:col-span-2 md:col-span-1">
            ...
            <h3 className="text-base sm:text-lg font-bold text-gray-900 mb-3 sm:mb-4">Data-Informed</h3>
            <p className="text-sm sm:text-base text-gray-600 leading-relaxed">
      ...
      <motion.div
        ...
        viewport={{ once: true, amount: 0.2 }}
        transition={{ duration: 0.5 }}
        className="text-center py-8 sm:py-12 md:py-16 bg-gray-50 rounded-xl sm:rounded-2xl px-4"
      >
        <h3 className="text-2xl sm:text-3xl font-bold text-gray-900 mb-4 sm:mb-6">Let's Build Something Great Together</h3>
